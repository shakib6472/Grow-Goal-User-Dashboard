...
if ($lesson_num) {
    ...
    error_log('Lesson Number Found. Lesson Number is: ' .  $lesson_num);
    ...
    $query = $wpdb->prepare("SELECT * FROM $table_name WHERE lesson_name = %d AND student_id = %d", $lesson_num, $user_id);
