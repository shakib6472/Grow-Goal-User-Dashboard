			...
			<div class="custom-right-top-second">
				<div class="custom-right-top-one">
					<div class="custom-right-date">
						...
						$query = $wpdb->prepare("SELECT * FROM $table_name WHERE student_id = %d", $user_id);
						...
						if ($nearest_result) {
							error_log(print_r($nearest_result, true)); // Log the nearest future booking
						} else {
							error_log("No future bookings found.");
						}
